 ...
 */
@Component
public class ShanDongCmccParser {
	protected static Logger logger = LoggerFactory.getLogger(ShanDongCmccParser.class);
...
//		}
		carrierInfo.getCarrierUserInfo().setProvince("山东"); // 所属省份
