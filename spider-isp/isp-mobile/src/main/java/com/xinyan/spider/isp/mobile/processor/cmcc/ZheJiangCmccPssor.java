...
import com.xinyan.spider.isp.mobile.parser.cmcc.ZheJiangCmccParser;
 ...
 * @version V1.0
 * @description
 * @date 2017年5月12日 下午3:22:12
 */
@Component
public class ZheJiangCmccPssor extends AbstractProcessor {

    @Autowired
    private ZheJiangCmccParser parser;

    protected static Logger logger = LoggerFactory.getLogger(ZheJiangCmccPssor.class);
