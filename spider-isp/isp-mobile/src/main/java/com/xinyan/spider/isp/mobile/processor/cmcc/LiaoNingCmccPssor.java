...
import com.xinyan.spider.isp.mobile.parser.cmcc.LiaoNingCmccParser;
 ...
 */
@Component
public class LiaoNingCmccPssor extends AbstractProcessor {

    @Autowired
    private LiaoNingCmccParser parser;

    protected static Logger logger = LoggerFactory.getLogger(LiaoNingCmccPssor.class);
