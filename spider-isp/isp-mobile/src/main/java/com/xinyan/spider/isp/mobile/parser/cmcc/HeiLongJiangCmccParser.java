 ...
 */
@Component
public class HeiLongJiangCmccParser {
	protected static Logger logger = LoggerFactory.getLogger(HeiLongJiangCmccParser.class);
...
//		}
		carrierInfo.getCarrierUserInfo().setProvince("黑龙江"); // 所属省份
